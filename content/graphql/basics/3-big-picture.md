...
![GraphQL query and resolvers](http://imgur.com/cP2i8Da.png)
*Each field in the query corresponds to a [resolver function](http://graphql.org/learn/execution/#root-fields-resolvers). The GraphQL server calls all required resolvers when a query comes in to fetch the specified data.*
