...
answers: ["Detailed documentation and many code samples", "An imperative and more predictable mutation API", "Declaring data dependencies as fragments alongside React components", "Relay Modern also includes a new server component"]
correctAnswer: 1
videoId: eIsctkVmq4Y
duration: 10
---
