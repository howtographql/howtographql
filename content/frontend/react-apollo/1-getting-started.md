...
```js{1,2}(path=".../hackernews-react-apollo/src/components/App.js")
...
```html{16-19}(path=".../hackernews-react-apollo/public/index.html")
...
[GraphQL Playground](https://github.com/graphql/graphql-playground) for us to
explore and work with the API.

![Run yarn dev and view the GraphQL Playground](https://imgur.com/9RC6x9S.png)
...
```json(nocopy)
{
  "data": {
    "feed": {
      "links": [
        {
          "id": "43f7d9a2-586e-40e7-8e84-d73d3abe543f",
          "description": "Prisma gives you a powerful database toolkit 😎",
          "url": "https://prisma.io"
        },
        {
          "id": "8791ed40-f685-4f8f-8e26-638af8074973",
          "description": "The best GraphQL client for React",
          "url": "https://www.apollographql.com/docs/react/"
        }
      ]
