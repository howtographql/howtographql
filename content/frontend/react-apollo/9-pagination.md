---
title: Pagination
pageTitle: 'Pagination with GraphQL, React and Apollo Tutorial'
...
Still in `LinkList.js`, adjust the `useQuery` hook to accept the variables we want to pass to the query.
