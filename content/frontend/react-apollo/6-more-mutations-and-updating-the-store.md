...
question: "What does the 'prisma push' command do?"
answers: ["It uploads the local schema changes to the remote Prisma service", "It pushes a git repository to Prisma you can manage your project and code together", "It tells the server to push its remote schema changes into the local project file", "There is no 'prisma push' command"]
correctAnswer: 0
videoId: ""
duration: 0		
videoAuthor: ""
