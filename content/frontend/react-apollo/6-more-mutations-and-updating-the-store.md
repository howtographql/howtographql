...
question: "What does the 'graphcool-framework deploy' command do?"
answers: ["It uploads the local schema changes to the remote Graphcool project", "It pushes a git repository to Graphcool so you can manage your project and code together", "It tells the server to push its remote schema changes into the local project file", "There is no 'graphcool-framework deploy' command"]
correctAnswer: 0
videoId: o0w0HS5vG5s
duration: 8
