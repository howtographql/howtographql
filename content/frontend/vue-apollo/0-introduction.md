...
In the [Clients](/advanced/0-clients/) section in the GraphQL lessons, we already covered the responsibilities of a GraphQL client on a higher level, now it's time to get a bit more concrete.
