...
Great! Now we can access the methods we need to implement
...
Open `index.js` and add an import statement for the
...
The referenced `Vote` type also needs to be defined in the
GraphQL schema:
