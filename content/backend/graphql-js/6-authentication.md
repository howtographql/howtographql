...
There's one more thing you need to do before you can launch the GraphQL server again and test the new functionality: Ensure the relation between `User` and `Link` gets properly resolved.
